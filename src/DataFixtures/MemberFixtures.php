...
class MemberFixtures extends Fixture implements DependentFixtureInterface
{
    ...
    public function load(ObjectManager $manager): void
    {
        ...
        foreach ($json->users as $data) {
            $member = new Member();
            $member->setLocalIdentifier('d-' . $data->id);
            ...
            $member
                ...
                ->setPhotoUrl($data->image . '&size=100x100')
                ->setJobTitle($company->title)
                ->setMailingLatitude($address->coordinates->lat)
                ->setMailingLongitude($address->coordinates->lng)
                ->setMailingAddressLine1($address->address)
                ->setMailingCity($address->city??null)
                ->setMailingState($address->state??null)
                ->setMailingPostalCode($address->postalCode??null)
                ->setEmployer($company->name)
                ->setPrimaryEmail($data->username . '@example.com')
                ->setExternalIdentifier(md5($member->getLocalIdentifier()));
...
//            dd($data);
        ...
        $member->setStatus($memberStatusMember);
        $member->setJoinDate(new \DateTimeImmutable('November 1, 1901'));
        ...
        $member->setBirthDate(new \DateTimeImmutable('1870-08-20'));
        ...
        $member->setBirthDate(new \DateTimeImmutable('1878-02-02'));
        $member->setClassYear(1902);
        $member->setStatus($memberStatusMember);
        $member->setJoinDate(new \DateTimeImmutable('November 1, 1901'));
        ...
        $member->setBirthDate(new \DateTimeImmutable('1882-05-07'));
        ...
        $member->setBirthDate(new \DateTimeImmutable('1883-05-21'));
        ...
        $member->setBirthDate(new \DateTimeImmutable('1879-11-13'));
        $member->setClassYear(1902);
        ...
        $member->setBirthDate(new \DateTimeImmutable('1880-10-28'));
        $member->setClassYear(1904);
        $member->setStatus($memberStatusMember);
        $member->setJoinDate(new \DateTimeImmutable('November 1, 1901'));
        ...
        $member->setBirthDate(new \DateTimeImmutable('1880-01-06'));
        $member->setClassYear(1902);
        $member->setStatus($memberStatusMember);
        $member->setJoinDate(new \DateTimeImmutable('November 1, 1901'));
        ...
        $member->setBirthDate(new \DateTimeImmutable('1876-01-31'));
        $member->setClassYear(1902);
        $member->setStatus($memberStatusMember);
        $member->setJoinDate(new \DateTimeImmutable('November 1, 1901'));
        ...
        $member->setBirthDate(new \DateTimeImmutable('1876-10-02'));
        $member->setClassYear(1902);
        $member->setStatus($memberStatusMember);
        $member->setJoinDate(new \DateTimeImmutable('November 1, 1901'));
        ...
        $member->setBirthDate(new \DateTimeImmutable('1878-11-25'));
        $member->setClassYear(1902);
        $member->setStatus($memberStatusMember);
        $member->setJoinDate(new \DateTimeImmutable('November 1, 1901'));
