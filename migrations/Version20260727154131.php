 ...
 */
final class Version20260727154131 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE communication_log (id INT GENERATED BY DEFAULT AS IDENTITY NOT NULL, logged_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, type VARCHAR(255) NOT NULL, summary TEXT NOT NULL, payload JSON DEFAULT NULL, created_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, updated_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, member_id INT NOT NULL, user_id INT DEFAULT NULL, PRIMARY KEY (id))');
        ...
        $this->addSql('CREATE TABLE donation (id INT GENERATED BY DEFAULT AS IDENTITY NOT NULL, donor_first_name VARCHAR(255) DEFAULT NULL, donor_last_name VARCHAR(255) DEFAULT NULL, receipt_identifier VARCHAR(255) DEFAULT NULL, received_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, campaign VARCHAR(255) DEFAULT NULL, description VARCHAR(255) DEFAULT NULL, amount NUMERIC(10, 2) NOT NULL, currency VARCHAR(255) NOT NULL, processing_fee NUMERIC(10, 2) NOT NULL, net_amount NUMERIC(10, 2) NOT NULL, donor_comment VARCHAR(255) DEFAULT NULL, internal_notes TEXT DEFAULT NULL, donation_type VARCHAR(255) DEFAULT NULL, card_type VARCHAR(255) DEFAULT NULL, last_four VARCHAR(255) DEFAULT NULL, is_anonymous BOOLEAN NOT NULL, is_recurring BOOLEAN NOT NULL, transaction_payload JSON NOT NULL, created_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, updated_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, member_id INT DEFAULT NULL, PRIMARY KEY (id))');
        $this->addSql('CREATE INDEX IDX_31E581A07597D3FE ON donation (member_id)');
        $this->addSql('CREATE TABLE event (id INT GENERATED BY DEFAULT AS IDENTITY NOT NULL, name VARCHAR(255) NOT NULL, code VARCHAR(255) NOT NULL, location VARCHAR(255) NOT NULL, description TEXT NOT NULL, start_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, created_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, updated_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, PRIMARY KEY (id))');
        ...
        $this->addSql('CREATE TABLE member_status (id INT GENERATED BY DEFAULT AS IDENTITY NOT NULL, code VARCHAR(255) NOT NULL, label VARCHAR(255) NOT NULL, is_inactive BOOLEAN NOT NULL, created_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, updated_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, PRIMARY KEY (id))');
        ...
        $this->addSql('CREATE TABLE tag (id INT GENERATED BY DEFAULT AS IDENTITY NOT NULL, tag_name VARCHAR(255) NOT NULL, created_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, updated_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, PRIMARY KEY (id))');
        ...
        $this->addSql('CREATE TABLE users (id INT GENERATED BY DEFAULT AS IDENTITY NOT NULL, email VARCHAR(180) NOT NULL, roles JSON NOT NULL, password VARCHAR(255) NOT NULL, totp_secret VARCHAR(255) DEFAULT NULL, name VARCHAR(255) DEFAULT NULL, last_login TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT NULL, timezone VARCHAR(255) DEFAULT NULL, created_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, updated_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, PRIMARY KEY (id))');
        $this->addSql('CREATE UNIQUE INDEX UNIQ_1483A5E9E7927C74 ON users (email)');
        $this->addSql('ALTER TABLE communication_log ADD CONSTRAINT FK_ED4161637597D3FE FOREIGN KEY (member_id) REFERENCES member (id) NOT DEFERRABLE');
        $this->addSql('ALTER TABLE communication_log ADD CONSTRAINT FK_ED416163A76ED395 FOREIGN KEY (user_id) REFERENCES users (id)');
        $this->addSql('ALTER TABLE directory_collection_member_status ADD CONSTRAINT FK_CC64EF66E9D937AC FOREIGN KEY (directory_collection_id) REFERENCES directory_collection (id) ON DELETE CASCADE');
        $this->addSql('ALTER TABLE directory_collection_member_status ADD CONSTRAINT FK_CC64EF662BDFD678 FOREIGN KEY (member_status_id) REFERENCES member_status (id) ON DELETE CASCADE');
